...
For my first tentative I used brute force which works for some of the examples (except the fourth one) so I need to try something smarter, maybe use [Dijkstra's algorithm](https://en.wikipedia.org/wiki/Dijkstra%27s_algorithm).